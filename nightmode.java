...
public class nightmode {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					nightmode window = new nightmode();
	...
	private void initialize() {	
		...
		lblQ2.setForeground(new Color(255, 255, 255));
		...
		rdbtnQ2A.setBackground(Color.BLACK);
		rdbtnQ2A.setForeground(new Color(255, 255, 255));
		Q2.add(rdbtnQ2A);
		...
		rdbtnQ2B.setBackground(Color.BLACK);
		rdbtnQ2B.setForeground(new Color(255, 255, 255));
		Q2.add(rdbtnQ2B);
		...
		rdbtnQ2C.setBackground(Color.BLACK);
		rdbtnQ2C.setForeground(new Color(255, 255, 255));
		Q2.add(rdbtnQ2C);
		...
		rdbtnQ2D.setBackground(Color.BLACK);
		rdbtnQ2D.setForeground(new Color(255, 255, 255));
		Q2.add(rdbtnQ2D);
		...
		lblQ3.setForeground(new Color(255, 255, 255));
		...
		rdbtnQ3A.setBackground(Color.BLACK);
		rdbtnQ3A.setForeground(new Color(255, 255, 255));
		Q3.add(rdbtnQ3A);
		...
		rdbtnQ3B.setBackground(Color.BLACK);
		rdbtnQ3B.setForeground(new Color(255, 255, 255));
		Q3.add(rdbtnQ3B);
		...
		rdbtnQ3C.setBackground(Color.BLACK);
		rdbtnQ3C.setForeground(new Color(255, 255, 255));
		Q3.add(rdbtnQ3C);
		...
		rdbtnQ3D.setBackground(Color.BLACK);
		rdbtnQ3D.setForeground(new Color(255, 255, 255));
		Q3.add(rdbtnQ3D);
